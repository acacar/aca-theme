;;; aca-theme.el --- My version of the leuven theme

;;; Commentary:

;; To use it, put the following in your Emacs configuration file:
;;
;;   (load-theme 'aca-theme t)
;;
...
(defun aca-scale-font (control default-height)
...
(let ((class '((class color) (min-colors 89)))
      ...
      (directory '(:weight bold :foreground "blue" :background "#F7F7F7"))
      ...
      (highlight-blue '(:background "#C6DCFF" :extend t))
      (highlight-blue2 '(:background "#D4E1F9" :extend t))
      ...
      (ol1 `(,@(aca-scale-font aca-scale-outline-headlines 1.3) :family "Sans Serif" :weight bold :overline "#A7A7A7" :foreground "#3C3C3C" :background "#F0F0F0" :extend t))
      (ol2 '(:height 1.0 :weight bold :family "Sans Serif" :overline "#123555" :foreground "#123555" :background "#E5F4FB" :extend t))
      (ol3 '(:height 1.0 :weight bold :family "Sans Serif" :foreground "#005522" :background "#EFFFEF" :extend t))
      (ol4 '(:height 1.0 :weight bold :family "Sans Serif" :slant normal :foreground "#EA6300" :extend t))
      (ol5 '(:height 1.0 :weight bold :family "Sans Serif" :slant normal :foreground "#E3258D" :extend t))
      (ol6 '(:height 1.0 :weight bold :family "Sans Serif" :slant italic :foreground "#0077CC" :extend t))
      (ol7 '(:height 1.0 :weight bold :family "Sans Serif" :slant italic :foreground "#2EAE2C" :extend t))
      (ol8 '(:height 1.0 :weight bold :family "Sans Serif" :slant italic :foreground "#FD8008" :extend t))
  ...
  (custom-theme-set-faces
   ...
   ;; Highlighting faces.
   `(fringe ((,class (:foreground "#4C9ED9" :background "#F7F7F7"))))
   ...
   `(font-lock-comment-delimiter-face ((,class (:foreground "#967AB2")))) ; #696969
   `(font-lock-comment-face ((,class (:slant italic :foreground "#967AB2")))) ; #696969
   ...
   `(font-lock-keyword-face ((,class (:bold nil :foreground "#384FF4")))) ; #3654DC
   ...
   `(gnus-picon ((,class (:foreground "yellow" :background "#F7F7F7"))))
   `(gnus-picon-xbm ((,class (:foreground "yellow" :background "#F7F7F7"))))
   `(gnus-server-closed ((,class (:slant italic :foreground "blue" :background "#F7F7F7"))))
   `(gnus-server-denied ((,class (:weight bold :foreground "red" :background "#F7F7F7"))))
   ...
   `(gnus-x-face ((,class (:foreground "black" :background "#F7F7F7"))))
   ...
   `(cfw:face-header ((,class (:foreground "#1662AF" :background "#F7F7F7" :weight bold))))
   ...
   `(cfw:face-saturday ((,class (:foreground "#4E4E4E" :background "#F7F7F7" :weight bold))))
   `(cfw:face-select ((,class (:foreground "#4A95EB" :background "#EDF1FA"))))
   `(cfw:face-sunday ((,class (:foreground "#4E4E4E" :background "#F7F7F7" :weight bold))))
   ...
   `(cfw:face-toolbar ((,class (:background "#F7F7F7"))))
   `(cfw:face-toolbar-button-off ((,class (:foreground "#CFCFCF" :background "#F7F7F7"))))
   ...
   `(custom-set ((,class (:foreground "blue" :background "#F7F7F7"))))
   ...
   `(diredp-executable-tag ((,class (:foreground "ForestGreen" :background "#F7F7F7"))))
   ...
   `(helm-ff-executable ((,class (:foreground "green3" :background "#F7F7F7"))))
   ...
   `(helm-selection ((,class (:background "#F7F7F7"))))
   ...
   `(aca-org-deadline-overdue ((,class (:foreground "#F22659"))))
   `(aca-org-deadline-today ((,class (:weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(aca-org-deadline-tomorrow ((,class (:foreground "#40A80B"))))
   `(aca-org-deadline-future ((,class (:foreground "#40A80B"))))
   `(aca-gnus-unseen ((,class (:weight bold :foreground "#FC7202"))))
   `(aca-gnus-date ((,class (:foreground "#FF80BF"))))
   `(aca-gnus-size ((,class (:foreground "#8FBF60"))))
   `(aca-todo-items-face ((,class (:weight bold :foreground "#FF3125" :background "#FFFF88"))))
   ...
   `(org-agenda-date ((,class (,@(aca-scale-font aca-scale-org-agenda-structure 1.6) :weight bold :foreground "#1662AF"))))
   `(org-agenda-date-today ((,class (,@(aca-scale-font aca-scale-org-agenda-structure 1.6) :weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(org-agenda-date-weekend ((,class (,@(aca-scale-font aca-scale-org-agenda-structure 1.6) :weight bold :foreground "#4E4E4E"))))
   ...
   `(org-agenda-structure ((,class (,@(aca-scale-font aca-scale-org-agenda-structure 1.6) :weight bold :foreground "#1F8DD6"))))
   ...
   `(org-default ((,class (:foreground "#333333" :background "#F7F7F7"))))
   ...
   `(org-latex-and-related ((,class (:foreground "#336699" :background "#F7F7F7"))))
   ...
   `(org-tag ((,class (:weight normal :slant italic :foreground "#9A9FA4" :background "#F7F7F7"))))
   ...
   `(term ((,class (:foreground "#333333" :background "#F7F7F7"))))
...
(custom-theme-set-variables 'aca
...
(when (and (boundp 'custom-theme-load-path)
           load-file-name)
  ;; Add theme folder to `custom-theme-load-path'.
